  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
    function menu(e) {
      ...
      let id = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr("href"),
        top = jquery__WEBPACK_IMPORTED_MODULE_0___default()(id).position().top;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("body,html").animate({ scrollTop: top }, 1500);
    }
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#menu").on("click", "a", menu);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#footer-and-scroll").on("click", "a", menu);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#back").on("click", "a", menu);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#products").on("click", "a", menu);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".post4-div").on("click", "a", menu);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".post5-div").on("click", "a", menu);
  });
